    ...
    (
        ...
        tests.utilities.make_graph(nodes=[
            ('0', dict(level=0,
                       ...
                       current_ratio=1.0000, optimal_ratio=1.00, solvers_ratio=0.0, product_ratio=0.0,
                       amount_to_add=1.0)),
            ('X', dict(level=1,
                       current_value=2500.0, optimal_value=0.00, solvers_value=0.0,
                       current_ratio=0.3125, optimal_ratio=0.45, solvers_ratio=0.0, product_ratio=0.0,
                       amount_to_add=0.0)),
            ('Y', dict(level=1,
                       current_value=5000.0, optimal_value=0.00, solvers_value=0.0,
                       current_ratio=0.6250, optimal_ratio=0.20, solvers_ratio=0.0, product_ratio=0.0,
                       amount_to_add=0.0)),
            ('Z', dict(level=1,
                       current_value=500.00, optimal_value=0.00, solvers_value=0.0,
                       current_ratio=0.0625, optimal_ratio=0.35, solvers_ratio=0.0, product_ratio=0.0,
                       amount_to_add=0.0)),
        ], edges=[
            ('0', 'X'), ('0', 'Y'), ('0', 'Z')
        ]),
