...
@pytest.mark.parametrize('frame,expected_graph', [
    (
        pd.DataFrame([
            dict(label='0', current_value=8000.0, optimal_ratio=1.0e2, amount_to_add=1.0, children=('X', 'Y', 'Z')),
